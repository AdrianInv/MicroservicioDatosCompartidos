package pe.com.sura.corporativo.model;
...
@Entity
@Table(name = "dato_compartido")

public class DatosCompartidos {
	
	
	public DatosCompartidos (String tipoDocumento, String numeroDocumento, String fechaSuscripcion, String fechaCancelacion, String estado, String empresa, String canal) {
